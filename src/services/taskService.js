...
const buildOldTaskPayload = ({
  ...
  const payload = {
    ...
    type: taskTypeValue,
    taskName: asString(taskChoice?.title || taskChoice?.taskName || ''),
    name: asString(taskChoice?.title || taskChoice?.taskName || ''),
    task: asString(taskChoice?.title || taskChoice?.taskName || ''),
